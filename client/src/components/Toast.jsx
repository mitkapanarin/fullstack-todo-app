...
const Toast = ({ message }) => {
  return (
    <div id="toast-success" className="absolute bottom-0 right-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
